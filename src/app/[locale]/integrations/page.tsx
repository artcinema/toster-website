...
const categories: Category[] = [
  {
    ...
    integrations: [
      { name: 'Bolt Food', abbr: 'BT', color: '#34D186', description: 'Native sync — orders, status updates, menus' },
      { name: 'Glovo', abbr: 'GL', color: '#FFC244', description: 'Two-way sync with automatic menu publish' },
      { name: 'Wolt', abbr: 'WO', color: '#009DE0', description: 'Real-time order ingestion via courier API' },
      { name: 'DoorDash', abbr: 'DD', color: '#FF3008', description: 'Drive API integration with live status push' },
      { name: 'Uber Eats', abbr: 'UE', color: '#06C167', description: 'Full menu management + order flow' },
      { name: 'Grubhub', abbr: 'GH', color: '#F63440', description: 'Direct API connection, no middleware' },
      { name: 'Just Eat', abbr: 'JE', color: '#FF8000', description: 'Live order sync across EU markets' },
      { name: 'Pyszne.pl', abbr: 'PY', color: '#FF6900', description: 'Polish market specialist integration' },
      { name: 'Dáme Jídlo', abbr: 'DJ', color: '#E30613', description: 'Czech Republic native aggregator' },
      { name: 'Lieferando', abbr: 'LI', color: '#FF8000', description: 'DACH region coverage' },
  ...
  },
  {
    ...
    integrations: [
      { name: 'LiqPay', abbr: 'LQ', color: '#00AFF0', description: 'Ukrainian card payments + installments', badge: 'UA' },
      { name: 'Stripe', abbr: 'ST', color: '#635BFF', description: 'Worldwide cards, Link, SEPA, and Stripe Tax' },
      { name: 'Viva Wallet', abbr: 'VW', color: '#0B4FBF', description: 'EU-native acquiring, 24 countries', badge: 'EU' },
      { name: 'Apple Pay', abbr: 'AP', color: '#1C1C1E', description: 'One-tap checkout on iOS and Safari' },
      { name: 'Google Pay', abbr: 'GP', color: '#4285F4', description: 'One-tap checkout on Android and Chrome' },
  ...
  },
  {
    ...
    integrations: [
      { name: 'Checkbox', abbr: 'CB', color: '#1E3A8A', description: 'Ukrainian fiscalization (PPO), online cashier', flag: '🇺🇦' },
      ...
      { name: 'Fiskaly', abbr: 'FK', color: '#000000', description: 'German TSE fiscalization (GoBD/GDPDU)', flag: '🇩🇪' },
      { name: 'VeriFacTu', abbr: 'VF', color: '#AA151B', description: 'Spanish electronic invoicing (VERI*FACTU)', flag: '🇪🇸' },
      { name: 'Stripe Tax', abbr: 'TX', color: '#635BFF', description: 'US sales tax, VAT, and GST automation', flag: '🇺🇸' },
    ],
  },
  {
    id: 'marketing',
    ...
    integrations: [
      { name: 'SendPulse', abbr: 'SP', color: '#6B4EFF', description: 'Email, SMS, Push, Viber, Automation 360' },
      { name: 'Meta Ads', abbr: 'FB', color: '#1877F2', description: 'Audience sync, conversion events, CAPI' },
      { name: 'Google Ads', abbr: 'GA', color: '#4285F4', description: 'Offline conversion import, audience lists' },
      { name: 'Telegram Ads', abbr: 'TG', color: '#229ED9', description: 'Sponsored messages, channel targeting' },
      { name: 'ElevenLabs', abbr: 'EL', color: '#000000', description: 'AI voice calls for reactivation campaigns' },
    ],
  },
  {
    id: 'ai',
    ...
    integrations: [
      { name: 'Anthropic Claude', abbr: 'AI', color: '#D97706', description: 'Powers every AI feature — Sonnet + Haiku + Vision' },
      { name: 'Qdrant', abbr: 'QD', color: '#DC143C', description: 'Vector search for semantic customer profiling' },
      { name: 'ElevenLabs', abbr: 'EL', color: '#000000', description: 'Conversational AI voice operator (24/7 inbound)' },
    ],
  },
  {
    id: 'infrastructure',
    ...
    integrations: [
      { name: 'Cloudflare R2', abbr: 'CF', color: '#F6821F', description: 'S3-compatible object storage, photos & invoices' },
      { name: 'DistanceMatrix.ai', abbr: 'DM', color: '#2563EB', description: 'Geocoding + routing for delivery zones' },
      { name: 'OSRM', abbr: 'OS', color: '#059669', description: 'Fallback open-source routing engine' },
      { name: 'Redis', abbr: 'RD', color: '#DC2626', description: 'BullMQ queues, Socket.IO adapter, caching' },
      { name: 'PostgreSQL', abbr: 'PG', color: '#336791', description: 'Primary database, 100+ models' },
    ],
  },
  {
    id: 'telephony',
    ...
    integrations: [
      { name: 'Asterisk AMI', abbr: 'AS', color: '#F59E0B', description: 'On-premise PBX integration, call events' },
      { name: 'ElevenLabs AI', abbr: 'EL', color: '#000000', description: 'Fully autonomous voice operator, 24/7' },
      { name: 'Twilio', abbr: 'TW', color: '#F22F46', description: 'Cloud telephony fallback, SMS, WhatsApp' },
      { name: 'Telegram', abbr: 'TG', color: '#229ED9', description: '13 bots — operators, kitchen, couriers, clients' },
    ],
  },
  {
    id: 'data',
    ...
    integrations: [
      { name: '1C ERP', abbr: '1C', color: '#FFCC00', description: 'Import products, inventory, and staff data' },
      { name: 'BigQuery', abbr: 'BQ', color: '#4285F4', description: 'Custom SQL reports on raw CRM data' },
      { name: 'CSV / Excel', abbr: 'XL', color: '#217346', description: 'Export any list or report, one click' },
...
function IntegrationCard({ integration }: { integration: Integration }) {
  return (
    ...
    >
      {/* Logo */}
      <div
        className="relative flex h-11 w-11 items-center justify-center rounded-xl text-white text-sm font-bold transition-all duration-300"
